...
Swiz_rastlist_JULY_18 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_July_2018_TIF"), 
                                   pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_JULY_18 <- lapply(Swiz_rastlist_JULY_18, raster)

# AUG 2018 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2018_TIF")
Swiz_rastlist_AUG_18 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2018_TIF"), 
                            pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_AUG_18 <- lapply(Swiz_rastlist_AUG_18, raster)

# JUNE 2019 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_June_2019_TIF")
Swiz_rastlist_JUNE_19 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_June_2019_TIF"), 
                                   pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_JUNE_19 <- lapply(Swiz_rastlist_JUNE_19, raster)

# JULY 2019 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_July_2019_TIF")
Swiz_rastlist_JULY_19 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_July_2019_TIF"), 
                                    pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_JULY_19 <- lapply(Swiz_rastlist_JULY_19, raster)

# AUG 2019 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2019_TIF")
Swiz_rastlist_AUG_19 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2019_TIF"), 
                                    pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_AUG_19 <- lapply(Swiz_rastlist_AUG_19, raster)

# JUNE 2020 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_June_2020_TIF")
Swiz_rastlist_JUNE_20 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_June_2020_TIF"), 
                                    pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_JUNE_20 <- lapply(Swiz_rastlist_JUNE_20, raster)

# JULY 2020 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_July_2020_TIF")
Swiz_rastlist_JULY_20 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_July_2020_TIF"), 
                                    pattern='.tif$', all.files=TRUE, full.names=FALSE)
allrasters_Swiz_JULY_20 <- lapply(Swiz_rastlist_JULY_20, raster)

# AUG 2020 TIF
setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2020_TIF")
Swiz_rastlist_AUG_20 <- list.files(path = setwd("~/Documents/Chapman Research/ECOSTRESS Project/Switzerland/Switz_WUE_Aug_2020_TIF"), 
                                   pattern='.tif$', all.files=TRUE, full.names=FALSE)
...
# Extend AUG 2018
extended_allrasters_Swiz_AUG_18 = lapply(allrasters_Swiz_AUG_18, resample, extend_whole, method = "bilinear")
